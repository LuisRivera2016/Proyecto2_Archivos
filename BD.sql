...
SELECT USUARIO_REQUISITO.ID_USUARIO,USUARIO_REQUISITO.DPI FROM USUARIO_REQUISITO
...
INNER JOIN PUESTO ON APLICANTE.ID_PUESTO = PUESTO.ID_PUESTO
INNER JOIN DEPARTAMENTO ON PUESTO.ID_DEPARTAMENTO = DEPARTAMENTO.ID_DEPARTAMENTO
WHERE DPI = 3048558980112 AND DEPARTAMENTO.ID_DEPARTAMENTO = 4;

SELECT * FROM USUARIO WHERE ID_USUARIO = 15;
